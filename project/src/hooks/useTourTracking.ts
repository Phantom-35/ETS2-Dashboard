...
import { TourData, TourReport, TourHistoryEntry } from '../types/tour';
import { saveTourToHistory, formatHistoryDate } from '../utils/storage';

export const useTourTracking = (data: TelemetryData | null) => {
  ...
  useEffect(() => {
    ...
    if (currentIncome > 0 && !tour) {
      ...
      let ecoRating: 'green' | 'yellow' | 'red' = 'green';
      let ecoScore = 100;
      ...
      const historyEntry: TourHistoryEntry = {
